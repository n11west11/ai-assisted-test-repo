...
from ai_assisted_test_repo.tools.ui.functions import ui_tools_dir
...
#         You have access to three main functions: execute_playwright and locator_find, and page_content

#         locator_find and page_content, may be used to find valid locators. Behind the scenes a page.content() call is ran and beautifulSoup is applied to the content and fed back through the function.

#         When running execute_playwright it is always beneficial to run these command before passing a locator object to execute_playwright.

#         execute_playwright is a function that takes a playwright function and executes it against
