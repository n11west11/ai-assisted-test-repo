...
from ai_assisted_test_repo.cookbooks.langgraph_graphql.profiles.base_profile import BaseProfile
from ai_assisted_test_repo.cookbooks.langgraph_graphql.profiles.graphql.app import GraphQLProfile
...
async def setup_agent(settings):
    profile = cl.user_session.get("profile") # type: BaseProfile
    await profile.update_settings(settings)


@cl.set_chat_profiles
async def chat_profile():
    return [
        GraphQLProfile.chat_profile,
    ]
