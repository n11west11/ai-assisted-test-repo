...
from ai_assisted_test_repo.cookbooks.single_agent_ui.profiles.base_profile import BaseProfile
from ai_assisted_test_repo.cookbooks.single_agent_ui.profiles.ui.ui_app import UITestProfile
